...
class SilverToGold:
    def __init__(self):
        ...
        self.output_cols = ['TituloObra', 'Fecha', 'Artista', 'Nacionalidad', 'Género', 'AñoNacimiento', 'AñoMuerte',
    ...
    def silver_to_gold(self):
        ...
        df_output[self.output_cols].to_csv(self.gold_path, sep=";", index=False)


    def apply_artist_catalogue(self):
        moma_gold = pd.read_csv(self.gold_path, sep=";",
